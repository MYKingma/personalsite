...
REC_SEARCH_TYPES_NL = ["Bakkerij", "Bar", "Cafe", "Museum", "Nachtclub", "Restaurant", "Winkel", "Slijterij", "Brouwerij", "Distilleerderij", "Wijnwinkel", "Koffiebranders", "Biercafé", "Terras", "IJssalon", "Cocktailbar", "Slagerij"]
REC_SEARCH_TYPES = ["", "bakery", "bar", "cafe", "museum", "night_club", "restaurant", "store", "liquor_store", "brewery", "distillery", "wineshop", "coffeeroasters", "beerbar", "terrace", "icecream", "cocktailbar", "butcher"]
ICON_DICT = {"bakery": "bread-slice", "book_store": "book", "casino": "dice", "library": "book-reader", "liquor_store": "wine-bottle", "cinema": "film", "museum": "palette", "night_club": "compact-disc", "spa": "hot-tub", "restaurant": "utensils", "brewery": "beer", "beerbar": "beer", "cocktailbar": "cocktail", "coffeeroasters": "coffee", "wineshop": "wine-glass-alt", "distillery": "glass-whiskey", "bar": "glass-cheers", "cafe": "mug-hot", "terrace": "umbrella-beach", "icecream": "ice-cream", "butcher": "drumstick-bite", "store": "shopping-basket"}
